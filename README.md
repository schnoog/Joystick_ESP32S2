...
It's the easy way to do it. You can choose the option in the Arduino IDE Tools menue or if you are using PlatformIO you can add the 
```
...
##### Set your custom USB VID/PID in "Enable USB CDC on boot" mode
